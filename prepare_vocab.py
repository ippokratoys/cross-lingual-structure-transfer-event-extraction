...
def parse_args():
    ...
    parser.add_argument('--glove_dir', default='dataset/fasttext', help='GloVe directory.')
    # parser.add_argument('--wv_file', default='glove.840B.300d.txt', help='GloVe vector file.')
    parser.add_argument('--wv_file', default='wiki.en.align.vec', help='GloVe vector file.')
